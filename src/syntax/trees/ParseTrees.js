...
export class GetAccessor extends ParseTree {
   ...
   */
  constructor(location, isStatic, name, body) {
    this.location = location;
...
export class Module extends ParseTree {
   ...
   */
  constructor(location, scriptItemList) {
    this.location = location;
...
export class PropertyMethodAssignment extends ParseTree {
   ...
   * @param {FunctionBody} functionBody
   */
  constructor(location, isStatic, isGenerator, name, formalParameterList, functionBody) {
    this.location = location;
    this.isStatic = isStatic;
    this.isGenerator = isGenerator;
    this.name = name;
